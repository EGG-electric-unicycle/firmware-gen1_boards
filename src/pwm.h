...
#define DUTY_CYCLE_NORMAL_MIN		0
#define DUTY_CYCLE_OFF			DUTY_CYCLE_NORMAL_MIN
#define DUTY_CYCLE_INVERTED_MAX		((2047/2) - 1)
#define DUTY_CYCLE_INVERTED_MIN 	0
#define MIN_POSITIVE_DUTY_CYCLE		140
#define MIN_NEGATIVE_DUTY_CYCLE		-140
#define FACTOR_DUTY_CYCLE		((1000.0 - MIN_POSITIVE_DUTY_CYCLE) / 1000.0)
